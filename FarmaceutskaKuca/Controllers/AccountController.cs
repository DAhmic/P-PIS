...
namespace FarmaceutskaKuca.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController() //: this(new ApplicationUserManager(new IUserStore<ApplicationUser>(new ApplicationDbContext()))
            //: this(new UserManager<ApplicationUser>(new IUserStore<ApplicationUser>(new ApplicationDbContext())))
        ...
        /* Dina verzija 1
                ...
                public ActionResult Login(korisnik k)
                {
                    ...
                    var user = db.korisnik.Where(a => a.username.Equals(k.username) && a.password.Equals(k.password)).FirstOrDefault();
                    if (user!= null)
                    {
                        Session["KorisnikId"] = user.id.ToString();
        ...
        */
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Login(korisnik k, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(k);
